use crate::modules::app::{CONFIG_SERVICE, FS_READ_SERVICE, PROJECT_SERVICE};
...
#[tauri::command]
pub fn get_recent_projects() -> Result<Vec<RecentProject>, ProjectError> {
...
#[tauri::command]
pub fn read_recent_projects(recent: Vec<RecentProject>) -> Result<Vec<Project>, ProjectError> {
